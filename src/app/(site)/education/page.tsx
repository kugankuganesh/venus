      ...
      <div className='container mx-auto max-w-6xl px-4'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-gray-600 dark:text-white/60 max-w-2xl mx-auto'>
            A Bachelor&apos;s degree in Software Engineering supported by
            hands-on experience across modern web, mobile, and ERP platforms.
          </p>
        </div>
        ...
        <div className='mb-20'>
          ...
          <div className='grid md:grid-cols-2 gap-6'>
            {[
              { title: 'Laravel Framework for Beginners', tag: 'Laravel' },
              { title: 'Laravel Advanced Topics', tag: 'Laravel' },
              { title: 'RESTful Services Fundamentals', tag: 'RESTful Services' },
              { title: 'Introduction to Project Management', tag: 'Project Management' },
              { title: 'Diploma in Project Management', tag: 'Project Management' },
              { title: 'Scrum Master Training', tag: 'Scrum Master' },
              { title: 'PRINCE2 Project Management Practitioner', tag: 'PRINCE2' },
              { title: 'Agile Essentials: A Practical Guide', tag: 'Agile' },
            ].map((cert) => (
              <div
                key={cert.title}
    ...
    <div className='bg-white dark:bg-darkmode p-6 rounded-lg shadow-service'>
      ...
      <div className='flex flex-wrap gap-3'>
        {[
          ...
          'CodeIgniter', 'Yii', 'RESTful APIs', 'PHP',
          'WordPress Custom Plugins', 'WooCommerce',
        ].map((skill) => (
          <span
            key={skill}
